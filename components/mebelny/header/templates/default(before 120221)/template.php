...
<div class="header-middle">
  <div class="container header-middle__wrap">
    ...
    <div class="header-item header-middle__item">
      ...
      <div class="header-item__text">
        <a class="header-item__title callibri_phone" href="tel:+78003500580" onclick="ym(26789943,'reachGoal','callme', {URL: document.location.href}); gtag('event', 'zvonok_ga');"><?=COption::GetOptionString("grain.customsettings","PHONE1");?></a>
        <!-- /.header-item__title -->
        <span class="header-item__desc" href="javascript:void(0)" onclick="openRecallPopup()" style="cursor:pointer">Перезвоните мне</span>
        <!-- /.header-item__desc -->
      </div>
      <!-- /.header-item__text -->
    </div>
  ...
  <div class="container header-bottom__wrap">
      ...
      <ul>
        ...
        if ($USER->IsAdmin()){?>
          <div class="main-menu__show-more menu__show-more">
            ...
            <span class="mobile">Вернуться на главную</span>
          </div>
        <?}?>
    ...
    if ($USER->IsAdmin()){?>
      <div class="header-item header-item__cart header-middle__item">
        ...
        <div class="header-item__text">
          <a href="/personal/cart/" class="header-item__desc" id="cart_desc">
