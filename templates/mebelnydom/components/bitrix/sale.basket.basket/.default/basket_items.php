					...
					>
								...
								<td class="item">
									...
									<div class="product-count-row">
										<div class="product-count-column">
		                                    ...
		                                    <div>В наличии <span class="product-count-green"><?= $arItem['AVAILABLE_QUANTITY'] ?></span></div>
	                                		<? endif ?>
	                                		<? if(!empty($arItem['PROPERTY_POD_ZAKAZ_VALUE'])): ?>
											<div>Под заказ <span class="product-count-brown"><?= $arItem['PROPERTY_POD_ZAKAZ_VALUE'] ?> дней</span></div>
											<? endif ?>
		                                </div>	
									</div>
						...
						?>
							<td class="control">
								...
								if ($bDeleteColumn):
									?>
									<a class="btn-link" href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delete"])?>"
