...
function updateBasketTable(basketItemId, res)
{
	...
	if (!!res.BASKET_DATA)
	{
		...
		if(BX('PRICE_WITHOUT_DISCOUNT_CUSTOM'))
		{
			BX('PRICE_WITHOUT_DISCOUNT_CUSTOM').innerHTML = res['BASKET_DATA']['DISCOUNT_PRICE_FORMATED'];
		}
...
$(function(){
	$('#clear-basket-btn').on('click', function(e){
		e.preventDefault();
		$('.modal-clearbasket').removeClass('fade').show();
	});
	$('.modal-clearbasket .modal-call__close-btn, #close-deleted-basket').on('click', function(e){
		e.preventDefault();
		$('.modal-clearbasket').addClass('fade').hide();
	});

	$('#delet-basket-btn').on('click', function(e){
		e.preventDefault();
		$.post(
			"/local/templates/mebelnydom/components/bitrix/sale.basket.basket/.default/ajax/delete.php",
			{
