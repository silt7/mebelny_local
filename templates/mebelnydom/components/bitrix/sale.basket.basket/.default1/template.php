		...
		<form method="post" action="<?=POST_FORM_ACTION_URI?>" name="basket_form" id="basket_form">
			<div id="basket_form_container">
				<div class="bx_ordercart">
					<? /*?><div class="bx_sort_container p15" style="margin-bottom:15px;">
						<span><?=GetMessage("SALE_ITEMS")?></span>&nbsp;&nbsp;
						<a href="javascript:void(0)" id="basket_toolbar_button" class="current btn btn-default btn-sm" onclick="showBasketItemsList()"><?=GetMessage("SALE_BASKET_ITEMS")?><div id="normal_count" class="flat" style="display:none">&nbsp;(<?=$normalCount?>)</div></a>
...
{ ?>
	<div class="p15"><? ShowError($arResult["ERROR_MESSAGE"]); ?></div>
<? }
?>