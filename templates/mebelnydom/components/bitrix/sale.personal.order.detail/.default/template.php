...
else
{
	...
	<div class="container-fluid sale-order-detail">
		...
		<div class="col-md-12 col-sm-12 col-xs-12 sale-order-detail-general mt30">
			<div class="row">
				<div class="col-md-12 cols-sm-12 col-xs-12 sale-order-detail-general-head">
					<span class="sale-order-detail-general-item" style="color:#000;">
						...
						<div class="col-md-12 col-sm-12 col-xs-12 sale-order-detail-about-order-inner-container">
							<div class="row">
								...
								<div class="col-md-2 col-sm-6 sale-order-detail-about-order-inner-container-repeat">
									<a href="<?=$arResult["URL_TO_COPY"]?>&amp;COPY_ORDER=Y" class="btn-def">
									...
									{
										?>
										<a href="<?=$arResult["URL_TO_CANCEL"]?>" class="link-cancel">
													...
													<div class="col-md-8 col-sm-7 col-xs-10 sale-order-detail-payment-options-methods-info">
														<div class="sale-order-detail-payment-options-methods-info-title">
															<div class="sale-order-detail-methods-title">
																...
																{
																	?>
																	<div class="_alert"><span class="sale-order-detail-payment-options-methods-info-title-status-alert">
																	<?=Loc::getMessage('SPOD_PAYMENT_UNPAID')?></span></div>
																	<?
																}
																?>
															</div>
													...
													if ($payment['PAY_SYSTEM']["IS_CASH"] !== "Y")
													{
														...
														<div class="sale-order-detail-payment-options-methods-button-container">
															...
															else
															{
																...
																{
																	?>
																	<a class="btn-theme btn-def active-button"><?= Loc::getMessage('SPOD_ORDER_PAY') ?></a>
																	<?
																}
															}
															?>
			...
			<div class="row sale-order-detail-total-payment">
				<div class="col-md-7 col-md-offset-5 col-sm-12 col-xs-12 sale-order-detail-total-payment-container">
					<div class="row">
						<ul class="col-md-8 col-sm-6 col-xs-6 sale-order-detail-total-payment-list-left pull-right">
							<?
							...
							?>
							<li class="sale-order-detail-total-payment-list-left-item"><?= Loc::getMessage('SPOD_SUMMARY')?>: <b><?=$arResult['PRICE_FORMATED']?></b></li>
						</ul>
					</div>
				</div>
			</div>
		</div><!--sale-order-detail-general-->
		<a class="sale-order-detail-back-to-list-link-down btn-def" href="<?= $arResult["URL_TO_LIST"] ?>">&larr; <?= Loc::getMessage('SPOD_RETURN_LIST_ORDERS')?></a>
	</div>
	<?
