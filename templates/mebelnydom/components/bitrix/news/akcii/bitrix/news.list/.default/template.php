                ...
                <div class="news__item-right">
                    ...
                    <div class="news__item-desc-wrap">
                        ...
                        <? if($end < 0) { ?>
                            ...
                            <div class="news__item-desc news__item-desc_inline">с <?=FormatDate("d M Y", MakeTimeStamp($arItem["PROPERTIES"]["BEGIN"]["VALUE"]));?> по <?=FormatDate("d M Y", MakeTimeStamp($arItem["PROPERTIES"]["END"]["VALUE"]));?></div>
                        <? } else { ?>
