			...
			?><div class="body"><?
				...
				foreach($arResult['ITEMS'] as $key=>$arItem) {
					...
					if(isset($arItem["PRICE"])) {
						...
						?><li class="lvl1<?if($isScrolable):?> scrolable<?endif;?><?if($isSearchable):?> searcheble<?endif;?>" data-propid="<?=$arItem['ID']?>" data-propcode="<?=$arItem['CODE']?>"><?
				...
				foreach($arResult['ITEMS'] as $key=>$arItem) {
					...
					?><li class="lvl1<?if($isScrolable):?> scrolable<?endif;?><?if($isSearchable):?> searcheble<?endif;?><?if($arItem["DISPLAY_EXPANDED"]!="Y"):?> closed<?endif?>" data-propid="<?=$arItem['ID']?>" data-propcode="<?=$arItem['CODE']?>"><?
						?><a href="#" class="showchild"><?
						?><svg class="svg-icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-arrow-filled-down"></use></svg><?
						?><?=$arItem['NAME']?><?if($arItem['FILTER_HINT']<>''):?><span class="hint">?<div><?=$arItem['FILTER_HINT']?></div></span><?endif;?></a><?
