...
(function() {
	...
	BX.Sale.OrderAjaxComponent = {
		...
		editTotalBlock: function()
		{
			...
			BX('ORDER_SUM').innerHTML = total.ORDER_PRICE_FORMATED;
			BX('ORDER_SALE').innerHTML = total.DISCOUNT_PRICE_FORMATED;
			...
			BX('ORDER_DOST').innerHTML = deliveryValue;
			BX('ORDER_ITOG').innerHTML = total.ORDER_TOTAL_PRICE_FORMATED;

			console.log(this.getAllFormData());
