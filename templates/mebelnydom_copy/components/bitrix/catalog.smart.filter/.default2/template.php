...
$templateData = array(
	'TEMPLATE_THEME' => $this->GetFolder().'/themes/blue/colors.css',
         ...
         <div class="filter_container ">
            ...
            <div class="filter_param_container">
             <div class="filter-range">
               ...
               <input id="range1" name="<?=$arItem["VALUES"]["MIN"]["CONTROL_NAME"]?>" type="hidden">
               <input id="range2" name="<?=$arItem["VALUES"]["MAX"]["CONTROL_NAME"]?>" type="hidden">
             </div>   
							   <script>
                                        $(function () {
