...
<!--	MAIN BLOCK	-->
	<div class="col-sm-9 bx-soa">
		...
		<div id="bx-soa-auth" class="bx-soa-section bx-soa-auth" style="display:none">
			...
			<div class="bx-soa-section-content container-fluid2"></div>
		</div>
		...
		<div id="bx-soa-orderSave" class="hidden-xs">
			<a href="javascript:void(0)" style="margin: 10px 0" class="pull-right btn btn-default btn-buy btn-lg">
				<?=$arParams['MESS_ORDER']?>
			</a>
		</div>
		...
		<div style="display: none;">
			...
			<div id="bx-soa-auth-hidden" class="bx-soa-section">
				<div class="bx-soa-section-content container-fluid2 reg"></div>
			</div>
		</div>
	</div>
