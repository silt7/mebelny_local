...
<form action="" method="get" class="form-light">
...
<div class="input-group">
	<input type="text" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>" class="form-control" />
<?endif;?>
...
<?else:?>
	<div class="not_found"><? ShowNote(GetMessage("SEARCH_NOTHING_TO_FOUND"));?></div>
<?endif;?>
</div>