							...
							?>
								...
								<td class="item td-name">
									...
									<div>
	                                    ...
	                                    <div class="text-ser">В наличии <span class="product-count-blue"><?= $arItem['AVAILABLE_QUANTITY'] ?></span></div>
                                		<? endif ?>
								...
								<td class="custom">
									<div class="__obozn hidden-xs hidden-sm">Колличество</div>
	...
	?>
			...
			<div class="w-50">
				<div class="__max_skidka">
					Всего вы экономите: <span id="PRICE_WITHOUT_DISCOUNT_CUSTOM"><?=str_replace(" ", "&nbsp;", $arResult["DISCOUNT_PRICE_FORMATED"])?></span>
				</div>
				<div class="bx_ordercart_order_pay_center">
					...
					?>
		            <a href="" class="btn-clear btn" id="clear-basket-btn">Очистить корзину</a>
    ...
    <div class="modal-call__wrap">
        <div class="modal-busket__dialog">
            ...
            <div class="modal-busket__container">
                <div class="modal-busket__title">Вы уверены, что хотите удалить все товары из корзины?</div>
                <div class="modal-busket__bottom">
                    <a href="" class="btn-def" id="delet-basket-btn">Да</a>
                    <a href="" class="btn-def" id="close-deleted-basket">Нет</a>
                </div>
            </div>
        </div>
    </div>
