...
<?if($arResult['SECTIONS']):?>
    ...
    <?/*** RelinkMenuTags ***/?>
    <div class="catalog__tags tags desktop">
        ...
        <?foreach($arResult['SECTIONS'] as $arSection):
            ...
            if($arSection['UF_TO_TAGS']==1 && $arSection["ACTIVE"]=="Y"):?>
                <? $class = $i<=7?'tags-item':'tags-item tags-item__hide';?>
                <?
                ...
                <?if($arSection['ELEMENT_CNT'] > 0):?>
                    <a href="<?=$arSection['SECTION_PAGE_URL']?>" class='<?= $class;?> w1510_menuTags_item <?= $active?>' data-filter="<?=$arFilterCodes[$arSection["ID"]]["UF_URL_FILTER"]?>">
        ...
        <span class="tags__show">Показать все категории</span>
    </div>  
