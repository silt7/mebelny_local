...
<!--<style>
.w_viewed_slider .slick-track {
    transform:none !important;
}
</style>-->
<?endif?>

            <div class="recomend__product w_viewed_slider">
                <span class="h3">Просмотренные товары</span>
                <div class="recomend-slider owl-carousel" id="owl-carousel-viewed">    
                    ...
                    <div class="page-ajax carousel-item">
                        ...
                        <div class="product-block">
                            ...
                            <div class="row" style="padding: 0 5px !important;">
                                ...
                                <div class="like">
                                    <i class="fa fa-retweet addToCompare <?= $compare?>" data-compare="<?=$arElement['ID']?>" onclick="compare_tov(<?=$arElement['ID']?>, this)" aria-hidden="true"></i>
