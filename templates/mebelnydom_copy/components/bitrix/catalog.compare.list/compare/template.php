...
if ($itemCount > 0)
{
	...
	<p class="compare-redirect"><a href="<? echo $arParams["COMPARE_URL"]; ?>" class="card__btn" style="width: 60%;"><? echo GetMessage('CP_BCCL_TPL_MESS_COMPARE_PAGE'); ?></a></p><?
}
?></div><?
if (!empty($arResult))
{
...
<tbody><?
	foreach($arResult as $arElement)
	{
		?><tr id="<? echo $idCompareRow.$arElement['PARENT_ID']; ?>">
			...
			<td><noindex><a href="javascript:void(0);"  data-id="<? echo $arElement['PARENT_ID']; ?>" rel="nofollow"><i class="fa fa-times-circle fa-lg" aria-hidden="true"></i><? //=GetMessage("CATALOG_DELETE")?></a></noindex></td>
		</tr><?
	}
?>
</tbody>
