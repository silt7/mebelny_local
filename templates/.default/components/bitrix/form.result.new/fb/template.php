...
?>
<script>
   $('form').addClass('js-ajax-form'); // добавить класс
</script>             
...
<div class="text-center">
				...
				<input <?=(intval($arResult["F_RIGHT"]) < 10 ? "disabled=\"disabled\"" : "");?> type="submit" name="web_form_submit" value="<?=htmlspecialcharsbx(strlen(trim($arResult["arForm"]["BUTTON"])) <= 0 ? GetMessage("FORM_ADD") : $arResult["arForm"]["BUTTON"]);?>" class="btn btn-b-white wow swing"/> 
</div>                        
